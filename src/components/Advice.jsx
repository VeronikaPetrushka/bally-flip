...
import { View, Text, TouchableOpacity, StyleSheet, Dimensions, ScrollView, Image, Animated, ImageBackground } from "react-native";
                ...
                {!topicChosen && !adviceChosen && (
                    <ScrollView contentContainerStyle={{ width: '100%', alignItems: 'center'}}>
                        ...
                        <TouchableOpacity style={[styles.btn, !selectedTopic && {backgroundColor: '#2e1212', opacity: 0.5}]} onPress={handleChooseTopic} disabled={!selectedTopic}>
                            <Text style={[styles.btnText, !selectedTopic &&  {color: '#fff'}]}>Choose</Text>
                        </TouchableOpacity>
                    </ScrollView>
                )}
